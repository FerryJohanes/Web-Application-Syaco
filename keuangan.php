            ...
            <div class="bg-img-fluid">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style="color:gainsboro">Keuangan</h1>
                        ...
                        <div class="card mb-4"  style="background-color : cornsilk; opacity:0.9">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="insert_keuangan.php"><button type="button right-" class="btn"style = "background-color :burlywood; color :black">+ Tambah Data Keuangan</button></a>
                            </div>
                            <div class="card-body">
                                <table id="example" >
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php
                                        $query = mysqli_query($mysqli,"SELECT * from keuangan");
