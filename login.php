...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    ...
    } else if(isset($_SESSION["pembeli"]) === true){
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($username_err) && empty($password_err)){
            ...
            $role = mysqli_query($mysqli, "SELECT role FROM users WHERE username='$username'");
                            ...
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="display: block;">
                                            <p class="text-center">Mohon mengisi formulir berikut untuk masuk</p>
                                            <?php 
                                            if(!empty($login_err)){
                                            ...
                                            <div class="d-grid">
                                                <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" style="color:black" value="submit">Masuk</button>
                                            </div> <br>
                                            ...
                                            <div class="text-center pt-1 mb-5 pb-1">
                                                ...
                                                <p> Daftar <a class="text-muted" href="register.php">Disini</a>.</p>
                                            </div>
