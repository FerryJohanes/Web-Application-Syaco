                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4"  style="background-color : cornsilk; opacity:0.95">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="insert_produk.php"><button type="button right-" class="btn"style = "background-color :burlywood; color :black">+ Tambah Data Produk</button></a>
                                <a href="customers.php"><button type="button right-" class="btn"style = "background-color :burlywood; color :black">Lihat Customers</button></a>
                            </div>
                                ...
                                <table id="example" >
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            echo "<th class='text-end'>".$value['jumlah_produk']."</th>";
                                            echo "<th class='text-end'>".$value['harga_produk']."</th>";
                                            echo "<th class='text-end'>".$value['tanggal_ditambahkan']."</th>";
                                            echo "<th class='text-end'>".$value['penjualan']." </th>";
                                            echo "<th class='text-center'>
                                            <a href='edit_produk.php?id=".$value['id_produk']."'>
                                            <i class='fa-solid fa-pen-to-square'></i></a> &nbsp
                                            <a href='hapus_produk.php?id=".$value['id_produk']."'>
                        ...
                        <div class="card mb-4" style="background-color : oldlace ; opacity:0.95">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="keuangan.php"><button type="button right-" class="btn"style = "background-color :burlywood; color :black">Keuangan</button></a>
                            </div>
                            <div class="card-body">
